...
exports.initialMigration1662468753557 = void 0;
class initialMigration1662468753557 {
    constructor() {
        this.name = 'initialMigration1662468753557';
    }
    up(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`CREATE TABLE "profiles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "bio" character varying(512) NOT NULL, "phone" character varying(24) NOT NULL, "addressId" uuid, "bankInfoId" uuid, "paymentInfoIdId" uuid, CONSTRAINT "REL_33e2671fc5a4f3bc5ba6a8b394" UNIQUE ("addressId"), CONSTRAINT "REL_ade582ccdd65522e01f22e29a3" UNIQUE ("bankInfoId"), CONSTRAINT "REL_deb91524d6e1a7d6f66e4a8840" UNIQUE ("paymentInfoIdId"), CONSTRAINT "PK_8e520eb4da7dc01d0e190447c8e" PRIMARY KEY ("id"))`);
            ...
            yield queryRunner.query(`ALTER TABLE "profiles" ADD CONSTRAINT "FK_33e2671fc5a4f3bc5ba6a8b3942" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "profiles" ADD CONSTRAINT "FK_ade582ccdd65522e01f22e29a32" FOREIGN KEY ("bankInfoId") REFERENCES "bank_info"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "profiles" ADD CONSTRAINT "FK_deb91524d6e1a7d6f66e4a8840c" FOREIGN KEY ("paymentInfoIdId") REFERENCES "payment_info"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            ...
            yield queryRunner.query(`ALTER TABLE "activities" ADD CONSTRAINT "FK_5803aa050358a4d5619c270a093" FOREIGN KEY ("addressId") REFERENCES "addresses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
            yield queryRunner.query(`ALTER TABLE "activities" ADD CONSTRAINT "FK_0e2bc0e1180cce4963c1274c180" FOREIGN KEY ("activityScheduleId") REFERENCES "activity_schedule"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    down(queryRunner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield queryRunner.query(`ALTER TABLE "profiles" DROP CONSTRAINT "FK_deb91524d6e1a7d6f66e4a8840c"`);
...
exports.initialMigration1662468753557 = initialMigration1662468753557;
