...
describe("View favorite profile", () => {
    ...
    test("Trying to view favorite profile", () => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c, _d, _e;
        ...
        const profile = yield (0, supertest_1.default)(app_1.default).post("/profile").send(mock_1.createProfile).set("Authorization", `Bearer ${login.body.token}`);
        const response = yield (0, supertest_1.default)(app_1.default).post(`/profile/favorite/${profile.body.id}`).set("Authorization", `Bearer ${login.body.token}`);
    ...
    test("Should not be able to view profile favorite without authentication", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.default).post("/users").send(mock_1.userCreate);
        const login = yield (0, supertest_1.default)(app_1.default).post("/login").send(mock_1.admLogin);
        const profile = yield (0, supertest_1.default)(app_1.default).post("/profile").send(mock_1.createProfile).set("Authorization", `Bearer ${login.body.token}`);
        const response = yield (0, supertest_1.default)(app_1.default).post(`/profile/favorite/${profile.body.id}`);
        expect(response.status).toBe(401);
        expect(response.body).toHaveProperty("message");
    }));
    test("Should not be able to view favorite profile with invalid id", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(app_1.default).post("/users").send(mock_1.userCreate);
        const login = yield (0, supertest_1.default)(app_1.default).post("/login").send(mock_1.admLogin);
        const response = yield (0, supertest_1.default)(app_1.default).post("/profile/favorite/1").set("Authorization", `Bearer ${login.body.token}`);
