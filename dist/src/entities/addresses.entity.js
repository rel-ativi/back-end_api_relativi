...
__decorate([
    (0, typeorm_1.ManyToOne)(() => districts_entity_1.District, { eager: true, onDelete: "SET NULL" }),
    __metadata("design:type", districts_entity_1.District)
], Address.prototype, "district", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => cities_entity_1.City, { eager: true, onDelete: "SET NULL" }),
    __metadata("design:type", cities_entity_1.City)
], Address.prototype, "city", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => states_entity_1.State, { eager: true, onDelete: "SET NULL" }),
    __metadata("design:type", states_entity_1.State)
], Address.prototype, "state", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => countries_entity_1.Country, { eager: true, onDelete: "SET NULL" }),
