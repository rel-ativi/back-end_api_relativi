...
__decorate([
    (0, typeorm_1.OneToOne)(() => addresses_entity_1.Address, (address) => address.address_of, {
        eager: true,
        nullable: true,
        onDelete: "SET NULL",
    }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => bank_info_entity_1.BankInfo, {
        eager: true,
        nullable: true,
        onDelete: "SET NULL",
    }),
...
__decorate([
    (0, typeorm_1.OneToOne)(() => payment_info_entity_1.PaymentInfo, {
        eager: true,
        nullable: true,
        onDelete: "SET NULL",
    }),
...
], Profile.prototype, "payment_info", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => activities_entity_1.Activity, (activities) => activities.created_by, {
        eager: true,
        nullable: true,
    }),
...
__decorate([
    (0, typeorm_1.OneToMany)(() => addresses_entity_1.Address, (addresses) => addresses.created_by, {
        eager: true,
        nullable: true,
    }),
    __metadata("design:type", Array)
], Profile.prototype, "addresses", void 0);
__decorate([
...
__decorate([
    (0, typeorm_1.ManyToMany)(() => activities_entity_1.Activity, {
        eager: true,
        nullable: true,
    }),
