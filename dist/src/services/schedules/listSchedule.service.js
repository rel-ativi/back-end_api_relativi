...
const listScheduleService = (profile_id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (profile.scheduled_activities.length === 0) {
        throw new AppError_1.AppError("There are no scheduled activities");
    }
